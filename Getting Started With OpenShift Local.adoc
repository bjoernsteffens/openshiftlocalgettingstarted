...
image::./images/asciidoc_convert_output_samples.jpg[[alt=ls,width=640,height=480]]
image::./images/asciidoc_convert_output_samples_epub.jpg[[alt=mobile,width=640,height=480]]
